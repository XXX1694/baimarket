import 'package:bai_market/features/auth/presentation/pages/login_page.dart';
...
import '../../features/live/presentation/pages/live_view.dart';
...
final router = GoRouter(
  initialLocation: '/',
  routes: [
    GoRoute(path: '/main', builder: (context, state) => OnboardingScreen()),
    ...
    GoRoute(
      path: '/live',
      builder: (context, state) => VerticalYoutubeStreamScreen(),
    ),
    GoRoute(
      path: '/product/:id',
