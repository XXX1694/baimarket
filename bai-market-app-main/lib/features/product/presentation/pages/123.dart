...
void _showAuthRequiredSnackBar(BuildContext context, AppLocalizations l10n) {
  final snackBar = SnackBar(
    content: Row(
      children: [
        Icon(Icons.lock_outline, color: Colors.white),
        SizedBox(width: 16),
        Expanded(child: Text('Требуется авторизация для этого действия')),
        TextButton(
          onPressed: () {
