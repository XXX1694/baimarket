...
```
cd existing_repo
git remote add origin https://gitlab.com/iriscompany/bai-market-app.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/iriscompany/bai-market-app/-/settings/integrations)
